...
import jp.co.soramitsu.oauth.uiscreens.theme.Sora
...
internal val header3 = soraTextStyleScreen().bold().fontSize(18.sp)
internal val header4 = soraTextStyleScreen().bold().fontSize(16.sp)

private fun soraTextStyleScreen(
